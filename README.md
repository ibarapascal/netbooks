...
1.4. File dependencies visualization by [arkit](https://github.com/dyatko/arkit)  
...
1.5. File history visualization by [gource](https://github.com/acaudwell/Gource)  

```shell
gource --seconds-per-day 10 -1920x1080 --auto-skip-seconds 0.5
```

1.6. Documents auto generated by `styleguidist`  [http://localhost:6060](http://localhost:6060)
